...
public class easyjet_stepdefoldmethod extends driverclass {
    ...
    public Project.pageobjectfiles.excel excel = PageFactory.initElements(driver, Project.pageobjectfiles.excel.class);
